...
import {CompaniesResponse, Company, SearchCompaniesParams, SearchParams} from '@/types/company'
import { useCompaniesStore } from '@/store/Companies'
import { errorDatabaseNotification } from '@/utils/notifications/db'

export const useSearchQueryCompanies = (searchParams:SearchParams | null) => {
